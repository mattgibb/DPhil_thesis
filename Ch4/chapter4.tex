...
\label{sec:defining_the_fibre_direction_within_the_laminae}
  ...
  \label{sub:normalising_the_cross_product}
    ...
    \begin{figure}[htbp]
      \centering
      \vspace{-2.5em}
      \subfigure[][]{\label{fig:oblique_vessel1}\includegraphics[width=0.91\textwidth]{Ch4/Figs/fibres_vessel1}}
      \subfigure[][]{\label{fig:oblique_vessel2}\includegraphics[width=0.91\textwidth]{Ch4/Figs/fibres_vessel2}} 
      \subfigure[][]{\label{fig:oblique_vessel3}\includegraphics[width=0.91\textwidth]{Ch4/Figs/fibres_vessel3}}
    ...
    \begin{figure}[htbp]
      \centering
      \vspace{-2.5em}
      \subfigure[][]{\label{fig:oblique_no_vessel1}\includegraphics[width=0.89\textwidth]{Ch4/Figs/fibres_no_vessel1}}
      \subfigure[][]{\label{fig:oblique_no_vessel2}\includegraphics[width=0.89\textwidth]{Ch4/Figs/fibres_no_vessel2}} 
      \subfigure[][]{\label{fig:oblique_no_vessel3}\includegraphics[width=0.89\textwidth]{Ch4/Figs/fibres_no_vessel3}}
