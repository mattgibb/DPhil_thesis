...
\label{sec:defining_the_fibre_direction_within_the_laminae}
  ...
  \label{sub:projecting_a_2_d_solution}
    ...
    The questions remains, in which orientation should solution~\ref{eqn:potential} be mapped? The following cubic dependency of overall fibre direction on depth of myocardial tissue is observed experimentally \cite{Potse2006,StreeterJr1969}. Let $e$ be a tissue depth parameter
