...
\label{sec:methods}
  Intro: Summary sentence or comment sentence, then list content.
    ...
    \end{equation}
        ...
        \begin{gather}
          \alpha \cdot \mathbf{T} = e^{\alpha\ln\mathbf{M}}(p - c) + c \\
          \begin{split}
        ...
        In order to derive the common centre of the two operands of operator $\cdot$, let us consider the infinitesimal case
        
        \begin{gather}
          \delta \cdot \mathbf{U} = (\delta \cdot \mathbf{S}) \oplus (\delta \cdot \mathbf{T}) \approx (\delta \cdot \mathbf{S}) (\delta \cdot \mathbf{T}) \\
          \begin{split}
            e^{\delta(\ln \mathbf{S} + \ln \mathbf{T})}\mathbf{p} + (\mathbf{I} - e^{\delta(\ln \mathbf{S} + \ln \mathbf{T})})\mathbf{c_U} =
              &e^{\delta \ln \mathbf{S}}e^{\delta \ln \mathbf{T}}\mathbf{p} \\
              &+ e^{\delta \ln \mathbf{S}}(\mathbf{I} - e^{\delta \ln \mathbf{T}})\mathbf{c_T} \\
              &+ (\mathbf{I} - e^{\delta \ln \mathbf{S}})\mathbf{c_S}.
          \end{split}
        \end{gather}
        ...
        In the opposing case, where $\mathbf{M} - \mathbf{I}$ is singular and there is no central invariate coordinate along the singular dimensions, it is of course natural that operator $\cdot$ interpolates the translation coordinates linearly along those dimensions as in (\ref{eqn:translation_cdot}), and that operator $\oplus$ sums translations arithmetically as in Equation~\ref{eqn:translation_oplus}.
