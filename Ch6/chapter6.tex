...
\label{sec:methods}
  ...
  \label{sub:slice_to_slice_diffusion_smoothing_algorithm}
    ...
    \subsubsection{Mathematical Treatise}
      ...
      \begin{figure}[htbp]
        \centering
    		\subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/1d_noise_000}}
    		\subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/1d_noise_001}}
    		\subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/1d_noise_003}}
    		\subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/1d_noise_015}}
    		\subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/1d_noise_099}}
    		\subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/1d_noise_299}}
    		\qquad
