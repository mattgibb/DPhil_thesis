...
\label{sec:results}
  ...
  \label{sub:regional_diffusion}
    ...
    \begin{sidewaysfigure}[p]
      \centering
      \subfigure[][Unsmoothed segmentation]{\includegraphics[width=0.4\textwidth]{Ch6/Figs/bottom_vessels/unsmoothed_segmentation}}
      \subfigure[][Globally smoothed segmentation]{\includegraphics[width=0.4\textwidth]{Ch6/Figs/bottom_vessels/globally_smoothed_segmentation}}
      \subfigure[][Locally smoothed segmentation]{\includegraphics[width=0.4\textwidth]{Ch6/Figs/bottom_vessels/locally_smoothed_segmentation}}
      \subfigure[][Overlay of vessel segmentations]{\includegraphics[width=0.4\textwidth]{Ch6/Figs/bottom_vessels/vessel_overlay}}
    ...
    A connected componenet segementation was employed to generate the segementations in Figure~\ref{fig:vessel_segmentations}, which, unlike methods such as level set segmentation or neighbourhood filters, does not introduce any artificial surface smoothing.
