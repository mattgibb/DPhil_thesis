...
END PROGRESS FROM CONFIRMATION REPORT 
  ...
  \label{sub:image_preparation}
    ...
    \begin{sidewaysfigure}[htbp]
      \centering
      \subfigure[][]{\includegraphics[height=0.31\textheight]{Ch6/Figs/LoRes_0_235}}
    ...
    \begin{figure}[htbp]
      \centering
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/LoRes_rgb_downsamples_1_0582}}
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/LoRes_rgb_downsamples_8_0582}}
      \caption{}
    ...
    \begin{figure}[htbp]
      \centering
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/HiRes_downsamples_8_0582}}
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/HiRes_downsamples_64_0582}}
    ...
    \begin{sidewaysfigure}[htbp]
      \centering
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/HiRes_downsamples_1_0582_zoom}}
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/HiRes_downsamples_8_0582_zoom}}
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/HiRes_downsamples_64_0582_zoom}}
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/LoRes_rgb_downsamples_1_0582_zoom}}
      \subfigure[][]{\includegraphics[width=0.4\pagewidth]{Ch6/Figs/LoRes_rgb_downsamples_8_0582_zoom}}
      \caption{Mention how the slice needs to be flipped and rotated to be in line with the block face image.}
      \label{fig:original_images}
    \end{sidewaysfigure}
  ...
  \label{sub:algorithms}
    ...
    \subsubsection{Rigid Registration} % (fold)
    ...
    % subsubsection rigid_registration (end)
    
    \subsubsection{Similarity and Affine Registrations} % (fold)
    ...
    % subsubsection similarity_and_affine_registrations (end)
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_x_geometric}}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_negative_x_geometric}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_y_geometric}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_z_geometric}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_x_rigid}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_negative_x_rigid}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_y_rigid}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_z_rigid}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_x_size}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_negative_x_size}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_y_size}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_z_size}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_x_affine}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_negative_x_affine}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_y_affine}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[p]
  \centering
  \subfigure[][]{\includegraphics[width=0.9\textheight]{Ch7/Figs/Rat28/contours/whole_positive_z_affine}}
  \caption{}
  \label{fig:image1.png}
\end{sidewaysfigure}
