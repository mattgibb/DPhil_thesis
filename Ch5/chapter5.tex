...
% section available_data (end)

\section{Software Pipeline} % (fold)
...
% section software_pipeline (end)

\section{Block Face Registration} % (fold)
...
% section block_face_registration (end)

\section{Diagnostics and Parameter Visualisation} % (fold)
...
% section diagnostics_and_parameter_visualisation (end)
